                            ...
                            if (c1.equals("View") || c1.equals("view") || c1.equals("4")){
                                ...
                                if (c1.equals("Delete") || c1.equals("delete") || c1.equals("3")){
                                    ...
                                    if (c4.equals("Appointment") || c4.equals("appointment") || c4.equals("2")) {
                                        ...
                                        for(int i = 0; i < deletingAppointments.size(); i++) {
                                            System.out.println(x + ": ");
                                            System.out.println("Type of appointment: " + deletingAppointments.get(i).getAptName());
                                            System.out.println("Appointment Location: " + deletingAppointments.get(i).getLocation());
                                            System.out.println("Date: " + deletingAppointments.get(i).getDate());
                                            System.out.println("Time: " + deletingAppointments.get(i).getTime());
                                            System.out.println("\n");
                                 ...
                                 // EDITING AN ITEM
                                 if (c1.equals("Edit") || c1.equals("edit") || c1.equals("2")){
                                    System.out.println("\n\n-------------------------------------\n\nWould you like to edit an assignment, appointment, or event?");
                                    System.out.println("\n\t1. Assignment\n\t2. Appointment\n\t3. Event");
                                    System.out.println("\nWhat would you like to edit? ");
                                    String c6 = s.nextLine();
    
                                    // EDITING AN ASSIGNMENT
                                    if (c6.equals("Assignment") || c6.equals("assignment") || c6.equals("1")) {
                                        System.out.println("\n-------------------------------------");
                                        System.out.println("\nHere is a list of your assignments.");
                                        System.out.println("Please enter the number the task is associated with to edit.\n");
                                        System.out.println("-------------------------------------\n\n\tASSIGNMENTS\n");
    
                                        ArrayList<Task> editingAssignments = new ArrayList<Task>();
                                        ...
                                        try {
                                            ...
                                            while ((lineText = in.readLine()) != null) {
                                                // Splitting the line
                                                String[] line = lineText.split(",");
                                                editingAssignments.add(new Task(line[0], line[1], line[2], line[3]));
                                            }
                                            in.close();
                                        } catch (IOException e) {
                                            System.out.println("File read error.");
                                        ...
                                        int x = 1;
                                        for(int i = 0; i < editingAssignments.size(); i++) {
                                            System.out.println(x + ": ");
                                            System.out.println("Assignment Name: " + editingAssignments.get(i).getName());
                                            System.out.println("Assignment Description: " + editingAssignments.get(i).getDesc());
                                            System.out.println("Class Name: " + editingAssignments.get(i).getCName());
                                            System.out.println("Due Date: " + editingAssignments.get(i).getDueDate());
                                            System.out.println("\n");
                                            x++;
                                        }
                                        ...
                                        int index = (Integer.parseInt(c7))-1;
                                        ...
                                        if (c8.equals("1") || (c8.equals("name"))) {
                                            System.out.println("Enter the new assignment name: ");
                                            String newName = s.nextLine();

                                            editingAssignments.get(index).setTaskName(newName);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");

                                            System.out.println("Assignment Name: " + editingAssignments.get(index).getName());
                                            System.out.println("Assignment Description: " + editingAssignments.get(index).getDesc());
                                            System.out.println("Class Name: " + editingAssignments.get(index).getCName());
                                            System.out.println("Due Date: " + editingAssignments.get(index).getDueDate());

                                            System.out.println("\n\n-------------------------------------");

                                            // Outputing into text file
                                                FileWriter writer = new FileWriter("assignmentOutput.txt");  

                                                for(int i = 0; i < editingAssignments.size(); i++) {
                                                    writer.write(editingAssignments.get(i).getName() + "," + editingAssignments.get(i).getDesc() + "," + editingAssignments.get(i).getCName() + "," + editingAssignments.get(i).getDueDate() + "\n");
                                                }
                                                
                                                writer.close();
                                        }

                                        if (c8.equals("2") || (c8.equals("description"))) {
                                            System.out.println("Enter the new assignment description: ");
                                            String newDesc = s.nextLine();

                                            editingAssignments.get(index).setTaskDesc(newDesc);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");
                                        ...
                                        if (c8.equals("3") || (c8.equals("class"))) {
                                            System.out.println("Enter the new class name: ");
                                            String newClassName = s.nextLine();

                                            editingAssignments.get(index).setTaskClass(newClassName);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");
                                        ...
                                        if (c8.equals("4") || (c8.equals("date"))) {
                                            System.out.println("Enter the new due date in MM/DD/YYYY format: ");
                                            String newDate = s.nextLine();

                                            editingAssignments.get(index).setTaskDue(newDate);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");
                                    ...
                                    if (c6.equals("Appointment") || c6.equals("appointment") || c6.equals("2")) {
                                        System.out.println("\n-------------------------------------");
                                        System.out.println("\nHere is a list of your appointments.");
                                        System.out.println("Please enter the number the task is associated with to edit.\n");
                                        System.out.println("-------------------------------------\n\n\tAPPOINTMENTS\n");
    
                                        ArrayList<Appointment> editingAppointments = new ArrayList<Appointment>();
                                        ...
                                        try {
                                            ...
                                            while ((lineText = in.readLine()) != null) {
                                                // Splitting the line
                                                String[] line = lineText.split(",");
                                                editingAppointments.add(new Appointment(line[0], line[1], line[2], line[3]));
                                            }
                                            in.close();
                                        } catch (IOException e) {
                                            System.out.println("File read error.");
                                        ...
                                        int x = 1;
                                        for(int i = 0; i < editingAppointments.size(); i++) {
                                            System.out.println(x + ": ");
                                            System.out.println("Type of appointment: " + editingAppointments.get(i).getAptName());
                                            System.out.println("Appointment Location: " + editingAppointments.get(i).getLocation());
                                            System.out.println("Date: " + editingAppointments.get(i).getDate());
                                            System.out.println("Time: " + editingAppointments.get(i).getTime());
                                            System.out.println("\n");
                                            x++;
                                        }
                                        ...
                                        if (c8.equals("1") || (c8.equals("type"))) {
                                            System.out.println("Enter the new appointment type: ");
                                            String newType = s.nextLine();

                                            editingAppointments.get(index).setAptName(newType);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");

                                            System.out.println("Type of appointment: " + editingAppointments.get(index).getAptName());
                                            System.out.println("Appointment Location: " + editingAppointments.get(index).getLocation());
                                            System.out.println("Date: " + editingAppointments.get(index).getDate());
                                            System.out.println("Time: " + editingAppointments.get(index).getTime());
                                            ...
                                            // Outputing into text file
                                                ...
                                                for(int i = 0; i < editingAppointments.size(); i++) {
                                                    writer.write(editingAppointments.get(i).getAptName() + "," + editingAppointments.get(i).getLocation() + "," + editingAppointments.get(i).getDate() + "," + editingAppointments.get(i).getTime() + "\n");
                                                }
                                                
                                                writer.close();
                                        }

                                        if (c8.equals("2") || (c8.equals("location"))) {
                                            System.out.println("Enter the new appointment location: ");
                                            String newLoc = s.nextLine();

                                            editingAppointments.get(index).setLocation(newLoc);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");
                                        ...
                                        if (c8.equals("3") || (c8.equals("date"))) {
                                            System.out.println("Enter the new date in MM/DD/YYYY format: ");
                                            String newDate = s.nextLine();

                                            editingAppointments.get(index).setDate(newDate);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");
                                        ...
                                        if (c8.equals("4") || (c8.equals("time"))) {
                                            System.out.println("Enter the new due date in HH:MM AM/PM format: ");
                                            String newTime = s.nextLine();

                                            editingAppointments.get(index).setTime(newTime);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");
                                    ...
                                    // EDITING AN EVENT
                                    if (c6.equals("Event") || c6.equals("event") || c6.equals("3")) {
                                        System.out.println("\n-------------------------------------");
                                        System.out.println("\nHere is a list of your events.");
                                        System.out.println("Please enter the number the task is associated with to edit.\n");
                                        System.out.println("-------------------------------------\n\n\tEVENTS\n");
    
                                        ArrayList<Event> editingEvents = new ArrayList<Event>();
                                        ...
                                        try {
                                            ...
                                            while ((lineText = in.readLine()) != null) {
                                                // Splitting the line
                                                String[] line = lineText.split(",");
                                                editingEvents.add(new Event(line[0], line[1], line[2], line[3]));
                                            }
                                            in.close();
                                        } catch (IOException e) {
                                            System.out.println("File read error.");
                                        ...
                                        int x = 1;
                                        for(int i = 0; i < editingEvents.size(); i++) {
                                            System.out.println(x + ": ");
                                            System.out.println("Event Name: " + editingEvents.get(i).getEvent());
                                            System.out.println("Event Location: " + editingEvents.get(i).getLocation());
                                            System.out.println("Date: " + editingEvents.get(i).getDate());
                                            System.out.println("Time: " + editingEvents.get(i).getTime());
                                            System.out.println("\n");
                                            x++;
                                        }
                                        ...
                                        if (c8.equals("1") || (c8.equals("name"))) {
                                            ...
                                            editingEvents.get(index).setEventName(newName);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");

                                            System.out.println("Event Name: " + editingEvents.get(index).getEvent());
                                            System.out.println("Event Location: " + editingEvents.get(index).getLocation());
                                            System.out.println("Date: " + editingEvents.get(index).getDate());
                                            System.out.println("Time: " + editingEvents.get(index).getTime());
                                            ...
                                            // Outputing into text file
                                                ...
                                                for(int i = 0; i < editingEvents.size(); i++) {
                                                    writer.write(editingEvents.get(i).getEvent() + "," + editingEvents.get(i).getLocation() + "," + editingEvents.get(i).getDate() + "," + editingEvents.get(i).getTime() + "\n");
                                                }
                                        ...
                                        if (c8.equals("2") || (c8.equals("location"))) {
                                            ...
                                            editingEvents.get(index).setLocation(newLoc);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");
                                        ...
                                        if (c8.equals("3") || (c8.equals("date"))) {
                                            ...
                                            editingEvents.get(index).setDate(newDate);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");
                                        ...
                                        if (c8.equals("4") || (c8.equals("time"))) {
                                            ...
                                            editingEvents.get(index).setTime(newTime);
                                            System.out.println("\n\n-------------------------------------\n\n");
                                            System.out.println("The updated task is shown below:\n\n");
